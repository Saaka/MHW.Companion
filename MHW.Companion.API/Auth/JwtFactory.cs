...
namespace MHW.Companion.API.Auth
{
    ...
    public class JwtFactory : IJwtFactory
    {
        ...
        public async Task<string> GenerateEncodedToken(string userName, ClaimsIdentity identity)
        {
            var claims = new[]
         {
                 ...
                 identity.FindFirst(Config.JwtConstants.Strings.JwtClaimIdentifiers.Rol),
                 identity.FindFirst(Config.JwtConstants.Strings.JwtClaimIdentifiers.Id)
             };
